...
func PacketTypeName(packetType uint8) string {
	...
	case PACKET_SESSION_CAPS:
		return "PACKET_SESSION_CAPS"
	case PACKET_SESSION_CAPS_ACK:
		return "PACKET_SESSION_CAPS_ACK"
	case PACKET_STREAM_FEC_SYMBOL:
		return "PACKET_STREAM_FEC_SYMBOL"
